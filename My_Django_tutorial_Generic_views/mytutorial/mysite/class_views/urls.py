...
from class_views.views import Perro, Gato, CreateAnimalFormView, SuccessView, AnimalListView,PublisherListView,PublisherDetailView


app_name = 'class_views'
urlpatterns = [
    path('animal/index', views.index1, name='index'),
